...
export default function Input() {
  ...
  return (
    <div className="relative  w-full">
      <div className="rounded-full p-1 py-2 px-2 border text-xs lg:text-base shadow-md  flex  w-full  hover:shadow-lg  ">

        <span className="mx-1">
        <SearchIcon className="h-6 mt-0.5 mr-3 text-gray-500"/>
          {/* <Image
            src="/search.PNG"
            alt="icons"
            width={40}
        ...
        />
        <MicrophoneIcon className="h-6 mr-2 mt-0.5 text-gray-700" />
        {/* <span>
          <Image
            src="/icons.PNG"
            alt="icons"
